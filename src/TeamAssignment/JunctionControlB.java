...
public class JunctionControlB extends RobotProgrammingDemo implements SensorPortListener {
	
	private static DifferentialPilot DP;

	public JunctionControlB () {
	...
	public static void main (String[] args) throws InterruptedException {
		...
		Behavior b2 = new JunctionB(DP, SensorPort.S1, SensorPort.S4);
